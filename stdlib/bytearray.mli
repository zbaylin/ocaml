...
external create : int -> 'a _string = "caml_create_string"
(** [String.create n] returns a fresh string of length [n].
   The string initially contains arbitrary characters.

   Raise [Invalid_argument] if [n < 0] or [n > ]{!Sys.max_string_length}. *)

val make : int -> char -> 'a _string
(** [String.make n c] returns a fresh string of length [n],
   filled with the character [c].

   Raise [Invalid_argument] if [n < 0] or [n > ]{!Sys.max_string_length}.*)

val copy : 'a _string -> 'b _string
(** Return a copy of the given string. *)

val sub : 'a _string -> int -> int -> 'b _string
...
val concat : 'a _string -> 'b _string list -> 'c _string
...
val uppercase : 'a _string -> 'b _string
(** Return a copy of the argument, with all lowercase letters
   translated to uppercase, including accented letters of the ISO
   Latin-1 (8859-1) character set. *)

val lowercase : 'a _string -> 'b _string
(** Return a copy of the argument, with all uppercase letters
   translated to lowercase, including accented letters of the ISO
   Latin-1 (8859-1) character set. *)

val capitalize : 'a _string -> 'b _string
(** Return a copy of the argument, with the first character set to uppercase. *)

val uncapitalize : 'a _string -> 'b _string
...
val ( ^ ) : 'a _string -> 'b _string -> string
(** Provided for completeness: a polymorphic version of the [(^)] operator
...
external unsafe_cast : 'a _string -> 'b _string = "%identity"
